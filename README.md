...
4. Deploy a specific integration by running `amp deploy integrations/hubspot -p <my-project-name>` or `amp deploy integrations/salesforce -p <my-project-name>` in the root of the project.
